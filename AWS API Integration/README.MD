...
A **serverless AWS Lambda solution** for fetching Energy Storage System (ESS) data, storing it in **Amazon DynamoDB**, and integrating with **Power BI** for real-time analytics.
